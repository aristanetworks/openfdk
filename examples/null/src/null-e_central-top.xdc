...
#-
#- Description:
#-   Constraints for the Null example on the e_central board standard.
#-
...
create_pblock sem
resize_pblock [get_pblocks sem] -add {SLICE_X115Y60:SLICE_X129Y89}
...
resize_pblock [get_pblocks sem] -add {DSP48E2_X3Y24:DSP48E2_X3Y35}
...
set_property IO_BUFFER_TYPE NONE [get_ports gt_refclk_out_*]
