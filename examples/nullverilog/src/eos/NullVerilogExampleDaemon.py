...
#
#  Description:
#    The NullVerilog example daemon which responds to changes in config, and
...
class NullVerilogExampleDaemon(
    ...
    def __init__(self, sdk):
        ...
        self.appdir = "/opt/apps/nullverilog"
        self.loaded_fpgas = []
        self.fpga_registers = {}
...
def main():
    ...
    sdk = eossdk.Sdk("NullVerilogExampleDaemon")
    _ = NullVerilogExampleDaemon(sdk)
